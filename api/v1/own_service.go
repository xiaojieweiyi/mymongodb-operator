...
func (ownService *OwnService) MakeOwnResource(instance *Mymongodb, logger logr.Logger,
	...
	//logger.Info("[own_service_74]svc.Spec.Selector:", labelMap)
	svc.Spec.Selector = instance.Labels
...
func (ownService *OwnService) OwnResourceExist(instance *Mymongodb, client client.Client,
...
func (ownService *OwnService) UpdateOwnResourceStatus(instance *Mymongodb, client client.Client,
...
func (ownService *OwnService) ApplyOwnResource(instance *Mymongodb, client client.Client,
