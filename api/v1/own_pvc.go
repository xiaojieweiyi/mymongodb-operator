...
func (ownPVC *OwnPVC) MakeOwnResource(instance *Mymongodb, logger logr.Logger,
...
func (ownPVC *OwnPVC) OwnResourceExist(instance *Mymongodb, client client.Client,
...
func (ownPVC *OwnPVC) UpdateOwnResourceStatus(instance *Mymongodb, client client.Client,
...
func (ownPVC *OwnPVC) ApplyOwnResource(instance *Mymongodb, client client.Client,
